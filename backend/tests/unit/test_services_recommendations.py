...
class TestRecommendationService:
    ...
    def test_get_embedding_recommendations_returns_cards(self):
    ...
    def test_get_similarity_recommendations_returns_cards(self):
    ...
    def test_ensemble_recommendations_combines_scores(self):
    ...
    def test_get_role_based_recommendations_returns_cards(self):
